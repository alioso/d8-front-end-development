...
Drupal has functions check_plain, check_markup, and filter_xss for sanitizing text before display. The religious use of these functions is the key to XSS prevention.
